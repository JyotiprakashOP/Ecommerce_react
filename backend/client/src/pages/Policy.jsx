...
function Policy() {
  return (
    <Layout>
      <div className="policyDescription p-3">
        <p>
        ...
        <h5 >
          <b className="policyPoints">1. Introduction</b>
        </h5>
        <p>
        ...
        <h5>
          <b className="policyPoints">2. Identifying pupose</b>
        </h5>
        <p>
        ...
        <h5>
          <b className="policyPoints">3. Consent</b>
        </h5>
        <p>
        ...
        <h5>
          <b className="policyPoints">4. Limiting Collection </b>
        </h5>
        <p>
        ...
        <h5>
          <b className="policyPoints">5. Limiting Use, Disclosure and Retention</b>
        </h5>
        <p>
        ...
        <h5>
          <b className="policyPoints">6. Accuracy</b>
        </h5>
        <p>
        ...
        <h5>
          <b className="policyPoints">7. Safeguarding Customer Information </b>
        </h5>
        <p>
        ...
        <h5>
          <b className="policyPoints">8. Openness</b>
        </h5>
        <p>
        ...
        <h5>
          <b className="policyPoints">9. Customer Access</b>
        </h5>
        <p>
        ...
        <h5>
          <b className="policyPoints">10. Handling Customer Complaints and Suggestions </b>
        </h5>
        <p>
        ...
        <h5>
          <b className="policyPoints">Additional Information </b>
        </h5>
        <h6>
          <i className="policySubPoints">Cookies</i>
        </h6>
        <p>
        ...
        <h6>
          <i className="policySubPoints">Other Websites</i>
        </h6>
        <p>
